       ...
       <div class="text-center" id="contenedor-formulario">
            ...
            <div class="container-md">
                <table class="table table-striped table-bordered table-hover">
                    <thead>
                        <th>ID</th>
                        <th>NOMBRES DE LA SEDE</th>
                        <th>DISTRITO DE LA SEDE</th>
                        <th>CIUDAD DE LA SEDE</th>
                    </thead>
                    <tbody>
                        <c:forEach items="${datosSedes}" var="datos">
                            <tr>
                                <td><c:out value="${datos.id}"></c:out></td>
                                <td><c:out value="${datos.nombre_sede}"></c:out></td>
                                <td><c:out value="${datos.distrito_sede}"></c:out></td>
                                <td><c:out value="${datos.ciudad_Sede}"></c:out></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
