            ...
            <div class="container-md">
                <table class="table table-striped table-bordered table-hover">
                    <thead>
                        ...
                        <th>PROFESION DEL DOCENTE</th>
                    </thead>
                    <tbody>
                        <c:forEach items="${datosDocente}" var="datos">
                            <tr>
                                <td><c:out value="${datos.id}"></c:out></td>
                                <td><c:out value="${datos.nombre_docente}"></c:out></td>
                                <td><c:out value="${datos.apellido_docente}"></c:out></td>
                                <td><c:out value="${datos.profesion_docente}"></c:out></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
