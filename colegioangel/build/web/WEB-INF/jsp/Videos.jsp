            ...
            <div class="container-md">
                <table class="table table-striped table-bordered table-hover">
                    <thead>
                        <th>ID</th>
                        <th>URL</th>
                        <th>DESCRIPCION DEL VIDEO</th>
                    </thead>
                    <tbody>
                        <c:forEach items="${datosVideo}" var="datos">
                            <tr>
                                <td><c:out value="${datos.id}"></c:out></td>
                                <td>
                                    <iframe width="420" height="215" src="${datos.url_video}" title="…" frameborder="0" allow="accelerometer; autoplay; clipboard-write;
                                            encrypted-media; gyroscope; picture-in-picture" allowfullscreen>                                                                                        
                                    </iframe>
                                </td>
                                <td><c:out value="${datos.descripcion_video}"></c:out></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
